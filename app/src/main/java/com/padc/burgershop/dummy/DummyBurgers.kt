package com.padc.burgershop.dummy
...
fun getDummyBurgers() : List<BurgerVO> {
    ...
    burgerTwo.burgerImageUrl =
        "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Big_Mac_hamburger.jpg/470px-Big_Mac_hamburger.jpg"

    val burgerThree = BurgerVO()
    burgerThree.burgerName = "Cheese Burger"
    burgerThree.burgerDescription =
    ...
    burgerThree.burgerImageUrl =
        "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Cheeseburger_with_fries.jpg/600px-Cheeseburger_with_fries.jpg"

    val burgerFour = BurgerVO()
    burgerFour.burgerName = "Veggie Burger"
    burgerFour.burgerDescription =
    ...
    burgerFour.burgerImageUrl =
        "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Veganburger.jpeg/440px-Veganburger.jpeg"

    val burgerFive = BurgerVO()
    burgerFive.burgerName = "Fish Burger"
    burgerFive.burgerDescription =
    ...
    burgerFive.burgerImageUrl =
        "https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Salmon_burger.jpg/440px-Salmon_burger.jpg"
